    ...
    <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <FadeIn className="lg:col-span-7">
                ...
                <div className="mt-12">
                    <a href="https://systematicgeeks.com/strategy-session" className="text-mint border-mint hover:text-white transition-colors uppercase inline-flex items-center gap-2 group text-sm tracking-wider border-b pb-1">
