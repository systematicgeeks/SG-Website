    ...
    <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="glass lg:p-16 border-white/10 border rounded-3xl p-8">
            ...
            <FadeIn delay={700} className="mt-16 text-center pt-8 border-t border-white/5">
                <a href="https://systematicgeeks.com/strategy-session" className="bg-mint text-black uppercase inline-flex items-center gap-3 hover:shadow-[0_0_20px_rgba(110,231,183,0.3)] transition-all duration-300 text-sm font-semibold tracking-wider rounded-full py-4 px-10">
